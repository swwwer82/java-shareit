...
class RequestControllerTest {
    ...
    void testCreate() throws Exception {
        ...
        when(requestService.create(Mockito.<Long>any(), Mockito.any())).thenReturn(buildResult);
    ...
    void testGetAll() throws Exception {
        when(requestService.getAll(Mockito.<Long>any(), Mockito.any())).thenReturn(new ArrayList<>());
