...
class BookingServiceImplTest {
    ...
    void testCreate() {
        ...
        when(bookingMapper.toBooking(Mockito.<Long>any(), Mockito.any())).thenReturn(booking);
        ...
        verify(bookingMapper).toBooking(Mockito.<Long>any(), Mockito.any());
    ...
    void testApproveBooking3() {
        ...
        doNothing().when(booking).setEndDate(Mockito.any());
        doNothing().when(booking).setId(Mockito.<Long>any());
        doNothing().when(booking).setItem(Mockito.any());
        doNothing().when(booking).setStartDate(Mockito.any());
        ...
        verify(booking).setEndDate(Mockito.any());
        verify(booking).setId(Mockito.<Long>any());
        verify(booking).setItem(Mockito.any());
        verify(booking).setStartDate(Mockito.any());
    ...
    void testGetAll() {
        ...
        when(bookingRepository.findAllByItem_Owner_idOrderByStartDateDesc(Mockito.<Long>any(), Mockito.any()))
        ...
        verify(bookingRepository).findAllByItem_Owner_idOrderByStartDateDesc(Mockito.<Long>any(), Mockito.any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
    ...
    void testGetAll3() {
        ...
        when(bookingRepository.findAllByStartDateBeforeAndEndDateAfterAndItem_Owner_idOrderByStartDateDesc(
                Mockito.any(), Mockito.any(), Mockito.<Long>any(), Mockito.any()))
                .thenReturn(new ArrayList<>());
    ...
    void testGetAll4() {
        ...
        ArrayList<BookingDto> bookingDtoList = new ArrayList<>();
        when(bookingMapper.toBookingDto(Mockito.<List<Booking>>any())).thenReturn(bookingDtoList);
        when(bookingRepository.findAllByEndDateBeforeAndItem_Owner_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any())).thenReturn(new ArrayList<>());

        List<BookingDto> actualAll = bookingServiceImpl.getAll(1L, BookingState.PAST, true, null);

        verify(bookingMapper).toBookingDto(Mockito.<List<Booking>>any());
        verify(bookingRepository).findAllByEndDateBeforeAndItem_Owner_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
        assertTrue(actualAll.isEmpty());
        assertSame(bookingDtoList, actualAll);
    }
    ...
    void testGetAll5() {
        ...
        ArrayList<BookingDto> bookingDtoList = new ArrayList<>();
        when(bookingMapper.toBookingDto(Mockito.<List<Booking>>any())).thenReturn(bookingDtoList);
        when(bookingRepository.findAllByStartDateAfterAndItem_Owner_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any())).thenReturn(new ArrayList<>());

        List<BookingDto> actualAll = bookingServiceImpl.getAll(1L, BookingState.FUTURE, true, null);

        verify(bookingMapper).toBookingDto(Mockito.<List<Booking>>any());
        verify(bookingRepository).findAllByStartDateAfterAndItem_Owner_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
        assertTrue(actualAll.isEmpty());
        assertSame(bookingDtoList, actualAll);
    ...
    void testGetAll6() {
        ...
        ArrayList<BookingDto> bookingDtoList = new ArrayList<>();
        when(bookingMapper.toBookingDto(Mockito.<List<Booking>>any())).thenReturn(bookingDtoList);
        when(bookingRepository.findAllByStartDateAfterAndBooker_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any())).thenReturn(new ArrayList<>());

        List<BookingDto> actualAll = bookingServiceImpl.getAll(1L, BookingState.FUTURE, false, null);

        verify(bookingMapper).toBookingDto(Mockito.<List<Booking>>any());
        verify(bookingRepository).findAllByStartDateAfterAndBooker_idOrderByStartDateDesc(Mockito.any(),
                Mockito.<Long>any(), Mockito.any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
        assertTrue(actualAll.isEmpty());
        assertSame(bookingDtoList, actualAll);
