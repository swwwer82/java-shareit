...
class BookingControllerTest {
    ...
    void testCreate() {
        ...
        BookingDto buildResult = itemResult.start(LocalDate.of(1970, 1, 1).atStartOfDay())
                ...
                .build();
        when(bookingService.create(Mockito.<Long>any(), Mockito.any())).thenReturn(buildResult);
        ...
        verify(bookingService).create(Mockito.<Long>any(), Mockito.any());
    ...
    void testGetAll() throws Exception {
        when(bookingService.getAll(Mockito.<Long>any(), Mockito.any(), anyBoolean(), Mockito.any()))
