...
class RequestServiceImplTest {
    ...
    void testCreate() {
        ...
        when(requestMapper.toRequestDto(Mockito.<Request>any())).thenReturn(buildResult);
        when(requestMapper.toRequest(Mockito.<Long>any(), Mockito.<RequestCreateDto>any())).thenReturn(request2);
        ...
        verify(requestMapper).toRequest(Mockito.<Long>any(), Mockito.<RequestCreateDto>any());
        verify(requestMapper).toRequestDto(Mockito.<Request>any());
    ...
    void testCreate2() {
        ...
        user.setName("Name");
        when(userService.validationFindUserById(Mockito.<Long>any())).thenReturn(user);
        when(requestMapper.toRequest(Mockito.<Long>any(), Mockito.<RequestCreateDto>any()))
    ...
    void testGetAllUserById() {
        ...
        user.setName("Name");
        when(userService.validationFindUserById(Mockito.<Long>any())).thenReturn(user);
        when(itemRepository.findAllByRequest_idIn(Mockito.<List<Long>>any())).thenReturn(new ArrayList<>());
        when(itemMapper.toItemDtoList(Mockito.<List<Item>>any())).thenReturn(new ArrayList<>());

        List<RequestDto> actualAllUserById = requestServiceImpl.getAllUserById(1L);

        verify(itemMapper).toItemDtoList(Mockito.<List<Item>>any());
        verify(itemRepository).findAllByRequest_idIn(Mockito.<List<Long>>any());
    ...
    void testGetAllUserById2() {
        ...
        when(userService.validationFindUserById(Mockito.<Long>any())).thenReturn(user);
        when(itemRepository.findAllByRequest_idIn(Mockito.<List<Long>>any())).thenReturn(new ArrayList<>());
        when(itemMapper.toItemDtoList(Mockito.<List<Item>>any())).thenThrow(new NotFoundException("An error occurred"));
    ...
    void testGetAllUserById4() {
        ...
        verify(itemMapper).toItemDtoList(Mockito.<List<Item>>any());
        verify(itemRepository).findAllByRequest_idIn(Mockito.<List<Long>>any());
        verify(requestMapper, atLeast(1)).toRequestDto(Mockito.<Request>any());
        verify(requestRepository).findAllByAuthor_id(Mockito.<Long>any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
    ...
    @Test
    void testGetAll() {
        when(requestRepository.findAllByAuthor_idNot(Mockito.<Long>any(), Mockito.<Pageable>any()))
        ...
        verify(itemMapper).toItemDtoList(Mockito.<List<Item>>any());
        verify(itemRepository).findAllByRequest_idIn(Mockito.<List<Long>>any());
        verify(requestRepository).findAllByAuthor_idNot(Mockito.<Long>any(), Mockito.<Pageable>any());
        verify(userService).validationFindUserById(Mockito.<Long>any());
    ...
    void testGetAll3() {
        ...
        ArrayList<Request> requestList = new ArrayList<>();
        requestList.add(request);
        when(requestRepository.findAllByAuthor_idNot(Mockito.<Long>any(), Mockito.<Pageable>any())).thenReturn(requestList);
