...
class ItemControllerTest {
    ...
    void testGetAll() throws Exception {
        when(itemService.getAll(Mockito.<Long>any(), Mockito.<Pageable>any())).thenReturn(new ArrayList<>());
    ...
    void testCreate() throws Exception {
        ...
        BookingItemDto nextBooking = idResult3.startDate(LocalDate.of(1970, 1, 1).atStartOfDay()).build();
        ItemDto buildResult = nameResult.nextBooking(nextBooking).requestId(1L).build();
        when(itemService.create(Mockito.<Long>any(), Mockito.<ItemCreateDto>any())).thenReturn(buildResult);
    ...
    void testUpdate() throws Exception {
        ...
        BookingItemDto nextBooking = idResult3.startDate(LocalDate.of(1970, 1, 1).atStartOfDay()).build();
        ItemDto buildResult = nameResult.nextBooking(nextBooking).requestId(1L).build();
        when(itemService.update(Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<ItemUpdateDto>any()))
    ...
    void testSearch() throws Exception {
        when(itemService.search(Mockito.<String>any(), Mockito.<Pageable>any())).thenReturn(new ArrayList<>());
    ...
    void testCreateComment() throws Exception {
        ...
        CommentDto buildResult = authorNameResult.created(LocalDate.of(1970, 1, 1).atStartOfDay())
                ...
                .text("Text")
                .build();
        when(itemService.createComment(Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<CommentCreateDto>any()))
                .thenReturn(buildResult);
